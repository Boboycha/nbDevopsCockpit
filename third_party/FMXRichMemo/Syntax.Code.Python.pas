...
procedure RegisterPythonSyntax;
...
begin
  ...
  FCallKey.Color := TCodeSyntax.Palette.FunctionColor;
...
procedure RegisterPythonSyntax;
begin
  TCodeSyntax.RegisterSyntax(['python', 'py'], TCodeSyntaxPython);
end;
