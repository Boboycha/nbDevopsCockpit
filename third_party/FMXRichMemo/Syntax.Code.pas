...
type
  ...
  TCodeSyntaxPalette = record
    ...
    class function Default: TCodeSyntaxPalette; static;
  end;
  ...
  public
    class var Palette: TCodeSyntaxPalette;
    class constructor Create;
    class procedure SetPalette(const APalette: TCodeSyntaxPalette);
...
class function TCodeSyntaxPalette.Default: TCodeSyntaxPalette;
begin
  Result.Keyword := $FFFFE0BC;
  Result.KeywordAlt := $FFC22700;
  Result.KeywordControl := $FFFF9900;
  Result.StringColor := $FF7FAAFF;
  Result.NumberColor := $FFFF7F85;
  Result.CommentColor := $FF88E775;
  Result.DirectiveColor := $FF3CB1FF;
  Result.FieldColor := $FFFD7C22;
  Result.FunctionColor := $FFDCBDFB;
  Result.PunctuationColor := $FF8F9AB0;
  Result.SelectorColor := $FFEEF6FF;
  Result.AttributeColor := $FFD8E8FF;
  Result.ErrorColor := $FFFF5A3C;
end;
...
class constructor TCodeSyntax.Create;
begin
  Palette := TCodeSyntaxPalette.Default;
end;
...
class procedure TCodeSyntax.SetPalette(const APalette: TCodeSyntaxPalette);
begin
  Palette := APalette;
end;
