unit Syntax.Code.MarkDown;

interface

uses
  System.SysUtils, System.Generics.Collections, FMX.TextLayout, FMX.Graphics,
  System.UITypes, Syntax.Code;
...
procedure RegisterMarkDownSyntax;
...
begin
  ...
  FMonoKey.Color := TCodeSyntax.Palette.StringColor;
...
procedure RegisterMarkDownSyntax;
begin
  TCodeSyntax.RegisterSyntax(['md', 'markdown'], TCodeSyntaxMD);
end;
