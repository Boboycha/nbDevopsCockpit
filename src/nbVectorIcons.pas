...
begin
  ...
  begin
    ...
    APath.Data := 'M 9.8 14.2 L 14.2 9.8 ' +
      'M 10.9 7.1 L 12.1 5.9 C 14 4 17.1 4 19 5.9 C 20.9 7.8 20.9 10.9 19 12.8 L 17.8 14 ' +
      'M 13.1 16.9 L 11.9 18.1 C 10 20 6.9 20 5 18.1 C 3.1 16.2 3.1 13.1 5 11.2 L 6.2 10'
